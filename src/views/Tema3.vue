...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 En Colombia, la Constitución Política de 1991, de acuerdo con la UPME (s.f.), elevó a norma constitucional la consideración, manejo y conservación de los recursos naturales y el medio ambiente, a través tres principios fundamentales: 

    .d-flex.flex-wrap.mb-5
      .col-xl-7.pe-xl-4.order-2.order-xl-1
        AcordionA(tipo="b" clase-tarjeta="tarjeta color-acordeon-a")
    ...
    .d-flex.flex-wrap.mb-5
      .col-xl-7.order-2.order-xl-1.pe-xl-4
        .p-3.mb-4.d-flex.flex-wrap.align-items-center(style="background-color: #EEEEEE")
        ...
        p.mb-0 Ghana tiene unos de los vertederos tecnológicos más grandes del mundo. #[b(style="color: #A50491") En el material complementario se encuentra un video donde se observa la gestión que hacen los pobladores para obtener recursos para subsistir, a costa de un daño ambiental enorme.]
          br
          br
    ...
    .cajon.color-primario.p-4.d-flex.flex-wrap
      p Aunque los trabajos con RAEE es poco probable que se trabaje con equipos energizados, existe la posibilidad de que, en ocasiones, deban hacer pruebas para determinar funcionalidad de algunos elementos por lo que se debe tener especial cuidado con estas zonas que representan un riesgo para la persona.
